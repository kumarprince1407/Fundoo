  ...
  return (
    <Box sx={{ display: "flex", color: "white" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {[
            { title: "Notes", icon: <LightbulbOutlinedIcon /> },
            { title: "Reminders", icon: <NotificationsNoneOutlinedIcon /> },
            { title: "Edit Lables", icon: <CreateOutlinedIcon /> },
            { title: "Archive", icon: <ArchiveOutlinedIcon /> },
            { title: "Bin", icon: <DeleteOutlineOutlinedIcon /> },
          ].map(({ title, icon }) => (
